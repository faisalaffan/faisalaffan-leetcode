...
**Soal:** [2541. Minimum Operations To Make Array Equal Ii](https://leetcode.com/problems/minimum-operations-to-make-array-equal-ii/)
...
**Fungsi Solusi:** `func minOperations(nums1 []int, nums2 []int, k int) int64`
