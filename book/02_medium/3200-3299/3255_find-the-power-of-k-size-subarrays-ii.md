...
**Soal:** [3255. Find The Power Of K Size Subarrays Ii](https://leetcode.com/problems/find-the-power-of-k-size-subarrays-ii/)
...
**Fungsi Solusi:** `func resultsArray(nums []int, k int) []int`
