...
**Soal:** [1715. Count Apples And Oranges](https://leetcode.com/problems/count-apples-and-oranges/)
...
**Fungsi Solusi:** `func countFruits(boxes []Box, chestMap map[int]Chest) (int, int)`
