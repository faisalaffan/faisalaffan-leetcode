...
**Soal:** [1746. Maximum Subarray Sum After One Operation](https://leetcode.com/problems/maximum-subarray-sum-after-one-operation/)
...
**Fungsi Solusi:** `func maxSumAfterOperation(nums []int) int`
