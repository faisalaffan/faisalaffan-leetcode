...
**Soal:** [1219. Path With Maximum Gold](https://leetcode.com/problems/path-with-maximum-gold/)

**Tingkat Kesulitan:** Sedang

**Kompleksitas Waktu:** O(m*n * 4^(k)) where k = max cells with gold  
**Kompleksitas Ruang:** O(k) for recursion
