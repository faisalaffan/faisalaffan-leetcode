...
**Soal:** [1144. Decrease Elements To Make Array Zigzag](https://leetcode.com/problems/decrease-elements-to-make-array-zigzag/)
...
**Fungsi Solusi:** `func movesToMakeZigzag(nums []int) int`
