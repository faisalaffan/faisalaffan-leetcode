...
**Soal:** [3679. Minimum Discards To Balance Inventory](https://leetcode.com/problems/minimum-discards-to-balance-inventory/)
...
**Fungsi Solusi:** `func minimumDiscardsToBalanceInventory(arrivals []int, w int, m int) int`
