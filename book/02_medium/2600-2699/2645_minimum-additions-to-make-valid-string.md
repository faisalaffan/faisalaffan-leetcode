...
**Soal:** [2645. Minimum Additions To Make Valid String](https://leetcode.com/problems/minimum-additions-to-make-valid-string/)
...
**Fungsi Solusi:** `func addMinimum(word string) int`
