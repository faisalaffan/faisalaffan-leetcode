...
**Fungsi Solusi:** `func filterRestaurants(restaurants [][]int, veganFriendly int, maxPrice int, maxDistance int) []int`

## 🔍 Petunjuk Penyelesaian

**Teknik:** Sorting

**Waktu:** O(n log n) for sorting  |  **Ruang:** O(n) for storing filtered results
