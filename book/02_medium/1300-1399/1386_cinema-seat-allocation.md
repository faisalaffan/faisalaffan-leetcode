...
**Fungsi Solusi:** `func maxNumberOfFamilies(n int, reservedSeats [][]int) int`

## 🔍 Petunjuk Penyelesaian

**Teknik:** HashMap

**Waktu:** O(n) where n = number of reserved seats  |  **Ruang:** O(k) where k = number of rows with reserved seats
