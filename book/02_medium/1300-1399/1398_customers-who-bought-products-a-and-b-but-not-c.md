...
**Fungsi Solusi:** `func customersABnotC(customers []struct { customerID int customerName string }, orders []struct { orderID int customerID int productName string }) []customerResult`

## 🔍 Petunjuk Penyelesaian

**Teknik:** HashMap, Sorting

**Waktu:** O(n) where n = number of orders  |  **Ruang:** O(k) where k = number of customers
