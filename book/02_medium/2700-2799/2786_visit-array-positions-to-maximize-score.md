...
**Soal:** [2786. Visit Array Positions To Maximize Score](https://leetcode.com/problems/visit-array-positions-to-maximize-score/)
...
**Fungsi Solusi:** `func VisitArrayPositionsToMaximizeScore(nums []int, x int) int64`
