...
**Soal:** [2718. Sum Of Matrix After Queries](https://leetcode.com/problems/sum-of-matrix-after-queries/)
...
**Fungsi Solusi:** `func SumOfMatrixAfterQueries(n int, queries [][]int) int64`
