...
**Soal:** [1669. Merge In Between Linked Lists](https://leetcode.com/problems/merge-in-between-linked-lists/)
...
**Fungsi Solusi:** `func mergeInBetween(list1 *ListNode, a int, b int, list2 *ListNode) *ListNode`
