...
**Fungsi Solusi:** `func flipBinaryTree(root *Node, leaf *Node) *Node`

## 🔍 Petunjuk Penyelesaian

**Waktu:** O(n), Space: O(1) where n = path length from leaf to root  |  **Ruang:** O(1) where n = path length from leaf to root
