...
**Soal:** [1461. Check If A String Contains All Binary Codes Of Size K](https://leetcode.com/problems/check-if-a-string-contains-all-binary-codes-of-size-k/)

**Tingkat Kesulitan:** Sedang

**Kompleksitas Waktu:** O(n*k) where n = len(s), or O(n) with bit manipulation  
**Kompleksitas Ruang:** O(2^k) for storing seen codes

**Algoritma:** Sliding Window (jendela geser), Bit Manipulation (operasi bitwise)
