...
**Soal:** [2195. Append K Integers With Minimal Sum](https://leetcode.com/problems/append-k-integers-with-minimal-sum/)
...
**Fungsi Solusi:** `func minimalKSum(nums []int, k int) int64`
