...
**Soal:** [2134. Minimum Swaps To Group All 1S Together Ii](https://leetcode.com/problems/minimum-swaps-to-group-all-1s-together-ii/)
...
**Fungsi Solusi:** `func minSwaps(nums []int) int`
