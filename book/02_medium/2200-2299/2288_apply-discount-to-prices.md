...
**Soal:** [2288. Apply Discount To Prices](https://leetcode.com/problems/apply-discount-to-prices/)
...
**Fungsi Solusi:** `func discountPrices(sentence string, discount int) string`
