...
**Soal:** [2280. Minimum Lines To Represent A Line Chart](https://leetcode.com/problems/minimum-lines-to-represent-a-line-chart/)
...
**Fungsi Solusi:** `func minimumLines(stockPrices [][]int) int`
