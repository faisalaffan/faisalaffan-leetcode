...
**Soal:** [3717. Minimum Operations To Make The Array Beautiful](https://leetcode.com/problems/minimum-operations-to-make-the-array-beautiful/)
...
**Fungsi Solusi:** `func minimumOperationsToMakeTheArrayBeautiful(nums []int) int`
