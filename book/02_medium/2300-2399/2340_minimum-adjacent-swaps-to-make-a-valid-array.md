...
**Soal:** [2340. Minimum Adjacent Swaps To Make A Valid Array](https://leetcode.com/problems/minimum-adjacent-swaps-to-make-a-valid-array/)
...
**Fungsi Solusi:** `func minimumSwaps(nums []int) int`
