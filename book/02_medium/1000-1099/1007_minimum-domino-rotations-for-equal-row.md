...
**Soal:** [1007. Minimum Domino Rotations For Equal Row](https://leetcode.com/problems/minimum-domino-rotations-for-equal-row/)
...
> **Ide Kunci:** Check if we can make all values equal to tops[0] or bottoms[0]
