...
**Fungsi Solusi:** `func SmallestGreaterMultipleMadeOfTwoDigits(k int, digit1 int, digit2 int) int`

## 🔍 Petunjuk Penyelesaian

**Teknik:** BFS, Sorting

**Waktu:** O(2^k * log n) where k is number of digits, Space: O(2^k)  |  **Ruang:** O(2^k)
