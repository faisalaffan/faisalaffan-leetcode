...
**Soal:** [1802. Maximum Value At A Given Index In A Bounded Array](https://leetcode.com/problems/maximum-value-at-a-given-index-in-a-bounded-array/)

**Tingkat Kesulitan:** Sedang

**Kompleksitas Waktu:** O(log maxVal), Space: O(1)  
**Kompleksitas Ruang:** O(1)

**Algoritma:** —

**Fungsi Solusi:** `func maxValue(n int, index int, maxSum int) int`
