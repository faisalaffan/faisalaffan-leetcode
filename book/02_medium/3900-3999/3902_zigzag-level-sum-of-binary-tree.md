...
**Soal:** [3902. Zigzag Level Sum Of Binary Tree](https://leetcode.com/problems/zigzag-level-sum-of-binary-tree/)
...
**Fungsi Solusi:** `func ZigzagLevelSumOfBinaryTree(root *TreeNode) []int`

> **Ide Kunci:** BFS level-order. At odd levels (left-to-right), stop at first
