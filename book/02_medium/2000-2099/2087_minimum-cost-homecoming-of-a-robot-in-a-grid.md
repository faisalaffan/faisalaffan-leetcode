...
**Soal:** [2087. Minimum Cost Homecoming Of A Robot In A Grid](https://leetcode.com/problems/minimum-cost-homecoming-of-a-robot-in-a-grid/)
...
**Fungsi Solusi:** `func minCost(startPos []int, homePos []int, rowCosts []int, colCosts []int) int`
