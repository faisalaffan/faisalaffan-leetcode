...
**Soal:** [2018. Check If Word Can Be Placed In Crossword](https://leetcode.com/problems/check-if-word-can-be-placed-in-crossword/)

**Tingkat Kesulitan:** Sedang

**Kompleksitas Waktu:** O(m*n*len(word))  
**Kompleksitas Ruang:** O(1)

**Algoritma:** —

**Fungsi Solusi:** `func placeWordInCrossword(board [][]byte, word string) bool`
