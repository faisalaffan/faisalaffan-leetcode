...
**Soal:** [2048. Next Greater Numerically Balanced Number](https://leetcode.com/problems/next-greater-numerically-balanced-number/)
...
**Fungsi Solusi:** `func nextBeautifulNumber(n int) int`
