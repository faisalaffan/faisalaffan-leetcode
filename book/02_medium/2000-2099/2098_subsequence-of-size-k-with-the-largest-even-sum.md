...
**Soal:** [2098. Subsequence Of Size K With The Largest Even Sum](https://leetcode.com/problems/subsequence-of-size-k-with-the-largest-even-sum/)
...
**Fungsi Solusi:** `func largestEvenSum(nums []int, k int) int64`
