...
**Soal:** [2069. Walking Robot Simulation Ii](https://leetcode.com/problems/walking-robot-simulation-ii/)
...
**Fungsi Solusi:** `func Constructor(width int, height int) Robot`
