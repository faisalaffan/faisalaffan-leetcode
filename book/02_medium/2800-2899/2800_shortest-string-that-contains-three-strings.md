...
**Soal:** [2800. Shortest String That Contains Three Strings](https://leetcode.com/problems/shortest-string-that-contains-three-strings/)
...
**Fungsi Solusi:** `func merge2(x, y string) string`
