...
**Fungsi Solusi:** `func Intersect(quadTree1 *QuadTreeNode, quadTree2 *QuadTreeNode) *QuadTreeNode`

## 🔍 Petunjuk Penyelesaian

**Waktu:** O(n) where n = number of nodes in smaller tree  |  **Ruang:** O(log n)
