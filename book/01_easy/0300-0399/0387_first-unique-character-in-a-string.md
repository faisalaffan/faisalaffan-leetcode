...
**Soal:** [0387. First Unique Character In A String](https://leetcode.com/problems/first-unique-character-in-a-string/)
...
**Fungsi Solusi:** `func FirstUniqueCharacterInAString(s string) int`
