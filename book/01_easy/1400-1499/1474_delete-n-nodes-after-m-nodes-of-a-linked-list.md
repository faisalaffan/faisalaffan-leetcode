...
**Soal:** [1474. Delete N Nodes After M Nodes Of A Linked List](https://leetcode.com/problems/delete-n-nodes-after-m-nodes-of-a-linked-list/)
...
**Fungsi Solusi:** `func deleteNodes(head *ListNode, m int, n int) *ListNode`
