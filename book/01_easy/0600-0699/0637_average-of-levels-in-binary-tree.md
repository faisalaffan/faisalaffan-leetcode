...
**Soal:** [0637. Average Of Levels In Binary Tree](https://leetcode.com/problems/average-of-levels-in-binary-tree/)
...
**Fungsi Solusi:** `func AverageOfLevelsInBinaryTree(root *TreeNode) []float64`
