...
**Soal:** [1597. Build Binary Expression Tree From Infix Expression](https://leetcode.com/problems/build-binary-expression-tree-from-infix-expression/)
...
**Fungsi Solusi:** `func expTree(s string) *Node`
