...
**Soal:** [2801. Count Stepping Numbers In Range](https://leetcode.com/problems/count-stepping-numbers-in-range/)
...
**Fungsi Solusi:** `func steppingNumbers(low, high string) int`
