...
**Soal:** [0920. Number Of Music Playlists](https://leetcode.com/problems/number-of-music-playlists/)
...
**Fungsi Solusi:** `func numMusicPlaylists(n int, goal int, k int) int`
