...
**Soal:** [2518. Number Of Great Partitions](https://leetcode.com/problems/number-of-great-partitions/)
...
**Fungsi Solusi:** `func numberOfGreatPartitions(nums []int, k int) int`
