...
**Soal:** [2524. Maximum Frequency Score Of A Subarray](https://leetcode.com/problems/maximum-frequency-score-of-a-subarray/)
...
**Fungsi Solusi:** `func maxFrequencyScore(nums []int, k int) int`

> **Ide Kunci:** Sliding window with frequency and contribution tracking.
