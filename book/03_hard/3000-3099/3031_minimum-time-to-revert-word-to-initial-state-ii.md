...
**Soal:** [3031. Minimum Time To Revert Word To Initial State Ii](https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-ii/)
...
> **Ide Kunci:** Z-algorithm (linear-time pattern matching)
