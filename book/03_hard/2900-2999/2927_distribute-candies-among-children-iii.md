...
**Soal:** [2927. Distribute Candies Among Children Iii](https://leetcode.com/problems/distribute-candies-among-children-iii/)
...
**Fungsi Solusi:** `func distributeCandies(n int, limit int) int`
