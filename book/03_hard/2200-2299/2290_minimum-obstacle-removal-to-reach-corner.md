...
**Soal:** [2290. Minimum Obstacle Removal To Reach Corner](https://leetcode.com/problems/minimum-obstacle-removal-to-reach-corner/)
...
**Algoritma:** BFS (Breadth-First Search / pencarian lebar), Dijkstra (lintasan terpendek), LIS (Longest Increasing Subsequence)

> **Ide Kunci:** 0-1 BFS (Dijkstra with deque since edge weights are 0 or 1).
