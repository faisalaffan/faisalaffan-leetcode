...
**Soal:** [2302. Count Subarrays With Score Less Than K](https://leetcode.com/problems/count-subarrays-with-score-less-than-k/)
...
> **Ide Kunci:** Sliding window. Score of subarray nums[l..r] = sum(nums[l..r]) * (r-l+1).
