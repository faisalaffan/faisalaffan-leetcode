...
**Soal:** [1851. Minimum Interval To Include Each Query](https://leetcode.com/problems/minimum-interval-to-include-each-query/)
...
> **Ide Kunci:** sort intervals by length ascending, sort queries with index.
