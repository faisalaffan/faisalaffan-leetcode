...
**Soal:** [0329. Longest Increasing Path In A Matrix](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/)
...
**Fungsi Solusi:** `func longestIncreasingPath(matrix [][]int) int`
