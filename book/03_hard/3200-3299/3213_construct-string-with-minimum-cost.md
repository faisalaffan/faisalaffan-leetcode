...
**Soal:** [3213. Construct String With Minimum Cost](https://leetcode.com/problems/construct-string-with-minimum-cost/)
...
> **Ide Kunci:** Trie + DP. Build a trie from words (store min cost per node).
