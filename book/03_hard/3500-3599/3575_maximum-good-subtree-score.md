...
**Soal:** [3575. Maximum Good Subtree Score](https://leetcode.com/problems/maximum-good-subtree-score/)
...
> **Ide Kunci:** DFS from root. For each node, check if all nodes in its subtree
