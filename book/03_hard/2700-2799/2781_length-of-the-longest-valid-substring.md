...
**Soal:** [2781. Length Of The Longest Valid Substring](https://leetcode.com/problems/length-of-the-longest-valid-substring/)
...
**Fungsi Solusi:** `func longestValidSubstring(word string, forbidden []string) int`
