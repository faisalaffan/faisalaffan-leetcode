...
**Soal:** [2499. Minimum Total Cost To Make Arrays Unequal](https://leetcode.com/problems/minimum-total-cost-to-make-arrays-unequal/)
...
> **Ide Kunci:** Count positions where nums1[i] == nums2[i]. Accumulate cost.
