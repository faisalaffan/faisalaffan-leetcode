...
**Soal:** [3463. Check If Digits Are Equal In String After Operations Ii](https://leetcode.com/problems/check-if-digits-are-equal-in-string-after-operations-ii/)
...
**Fungsi Solusi:** `func binomMod5(n, k int) int`
