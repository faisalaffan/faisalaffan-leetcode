...
**Soal:** [1611. Minimum One Bit Operations To Make Integers Zero](https://leetcode.com/problems/minimum-one-bit-operations-to-make-integers-zero/)
...
**Fungsi Solusi:** `func minimumOneBitOperations(n int) int`
