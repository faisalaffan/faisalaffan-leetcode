...
**Soal:** [1602. Find Nearest Right Node In Binary Tree](https://leetcode.com/problems/find-nearest-right-node-in-binary-tree/)
...
**Fungsi Solusi:** `func findNearestRightNode(root *TreeNode, u *TreeNode) *TreeNode`
