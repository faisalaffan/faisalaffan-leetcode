...
**Soal:** [3956. Maximum Sum Of M Non Overlapping Subarrays I](https://leetcode.com/problems/maximum-sum-of-m-non-overlapping-subarrays-i/)
...
> **Ide Kunci:** DP with prefix sums. dp[i][j] = max sum using first i
