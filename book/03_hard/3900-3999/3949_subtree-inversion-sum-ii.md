...
**Soal:** [3949. Subtree Inversion Sum Ii](https://leetcode.com/problems/subtree-inversion-sum-ii/)
...
**Algoritma:** DFS (Depth-First Search / pencarian kedalaman), Fenwick Tree (Binary Indexed Tree)

> **Ide Kunci:** DFS with Fenwick tree for inversion counting. For
