...
**Soal:** [3806. Maximum Bitwise And After Increment Operations](https://leetcode.com/problems/maximum-bitwise-and-after-increment-operations/)
...
> **Ide Kunci:** For each bit position from high to low, check if we can
