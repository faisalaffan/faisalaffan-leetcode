...
**Soal:** [1359. Count All Valid Pickup And Delivery Options](https://leetcode.com/problems/count-all-valid-pickup-and-delivery-options/)
...
**Fungsi Solusi:** `func countOrders(n int) int`
