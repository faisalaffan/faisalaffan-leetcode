...
**Soal:** [1368. Minimum Cost To Make At Least One Valid Path In A Grid](https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid/)
...
**Fungsi Solusi:** `func minCost(grid [][]int) int`
